...
namespace CommonLib
{
    ...
    public sealed class mysqlapisingleton
    {
        ...
        private string CONNECTION_STRING = @"host=127.0.0.1;database=tasks_tracking_db;user=sa;password=123456789;port=3306";
        ...
        private mysqlconnectionstringdto get_connection_string_dto()
        {
            try
            {
                _connectionstringdto = new mysqlconnectionstringdto();
        ...
        public bool createdatabase()
        {
            try
            {
                string _default_database_name = utilzsingleton.getInstance(_notificationmessageEventname).getappsettinggivenkey("mysql_database", "tasks_tracking_db");
                _connectionstringdto = getmysqlconnectionstringdto();
                _connectionstringdto.database = "mysql";
                ...
                using (var con = new MySqlConnection(CONNECTION_STRING))
                {
                    ...
                    {
                        cmd.ExecuteNonQuery();
                        this._notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("successfully created database [ " + _default_database_name + " ] in " + DBContract.mysql + ".", TAG));
                        return true;
                    }
                }
            }
        ...
        public void updateexistingdbschema()
        {
            try
            {
                ...
                //  DBContract.propertiesentitytable.PROPERTIES_TABLE_NAME +
                //      " ADD " +
                //      DBContract.propertiesentitytable.CROP_DISEASE_CATEGORY + 
                //      " VARCHAR(MAX) "; 
        ...
        public responsedto checkconnectionasadmin(mysqlconnectionstringdto _connectionstringdto)
        {
            ...
            try
            {
                ...
                {
                    _responsedto.isresponseresultsuccessful = true;
                    _responsedto.responsesuccessmessage = "connection to mysql successfull. Logs count [ " + count + " ]";
                    return _responsedto;
                }
                else
                {
        ...
        public responsedto truncate_database()
        {
            ...
            try
            {
                ...
                _responsedto.isresponseresultsuccessful = true;
                _responsedto.responsesuccessmessage = "Tables successfully truncated in " + DBContract.mysql;
