...
namespace CustomerModule.Views
{
    public partial class SolidarityGroupsListForm : Form
    {
        ...
        #region "Constructor"
        public SolidarityGroupsListForm(string _user, string Conn)
        {
            InitializeComponent();
        ...
        private void btnEdit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DAL.tbl_solidarity_groups solidaritygroup = (DAL.tbl_solidarity_groups)bindingSourceSolidarityGroup.Current;
                    EditSolidarityGroupForm epf = new EditSolidarityGroupForm(solidaritygroup, user, connection) { Owner = this };
                    epf.Text = solidaritygroup.name.ToUpper().Trim();
                    epf.ShowDialog();
                }
            }
            catch (Exception ex)
        ...
        private void BindGrid(DataTable dt)
        {
            try
            {
                ...
                bindingSourceSolidarityGroup.DataSource = dt;
                dataGridViewSolidarityGroup.DataSource = bindingSourceSolidarityGroup;
                groupBox1.Text = bindingSourceSolidarityGroup.Count.ToString();
        ...
        public void RefreshGrid(int pageIndex)
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("GetSolidarityGroupPageWise", con))
                    {
