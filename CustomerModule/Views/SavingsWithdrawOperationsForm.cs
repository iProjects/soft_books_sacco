...
{
    public partial class SavingsWithdrawOperationsForm : Form
    {
        ...
        #region "Constructor"
        public SavingsWithdrawOperationsForm(ClientSavingContractModel saving_contract, CurrencyModel currencymodel, int userid, string Conn)
        {
            InitializeComponent();
        ...
        private void SavingsFirstDepositForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                txtDescription.Text = "Withdrawal";
        ...
        private void btnWithdraw_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
