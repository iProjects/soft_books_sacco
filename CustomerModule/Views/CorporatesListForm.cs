...
namespace CustomerModule.Views
{
    public partial class CorporatesListForm : Form
    {
        ...
        #region "Constructor"
        public CorporatesListForm(string _user, string Conn)
        {
            InitializeComponent();
        ...
        private void btnEdit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                ...
                {
                    DAL.Corporate corporate = (DAL.Corporate)bindingSourceCorporates.Current;
                    EditCorporateForm ecf = new EditCorporateForm(user, connection, corporate) { Owner = this };
                    ecf.Text = corporate.name.ToUpper().Trim();
                    ecf.ShowDialog();
                }
            }
            catch (Exception ex)
        ...
        private void dataGridViewCorporates_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            try
            {
        ...
        private void BindGrid(DataTable dt)
        {
            try
            {
                ...
                bindingSourceCorporates.DataSource = dt;
                dataGridViewCorporates.DataSource = bindingSourceCorporates;
                groupBox1.Text = bindingSourceCorporates.Count.ToString();
        ...
        public void RefreshGrid(int pageIndex)
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("GetCoporatesPageWise", con))
                    {
