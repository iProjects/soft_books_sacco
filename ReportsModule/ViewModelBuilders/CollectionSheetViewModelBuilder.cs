...
{
    public class CollectionSheetViewModelBuilder
    {
        ...
        public CollectionSheetViewModelBuilder(string Conn)
        {
        ...
        public CollectionSheetViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new CollectionSheetViewModel();
