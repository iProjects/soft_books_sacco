...
{
    public class ClientsandLoanStatisticsModelBuilder
    {
        ...
        public ClientsandLoanStatisticsModelBuilder(string Conn)
        {
        ...
        public ClientandLoanStatisticsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClientandLoanStatisticsViewModel();
