...
{
    public class EvolutionOfTotalNoOfClientsModelBuilder
    {
        ...
        public EvolutionOfTotalNoOfClientsModelBuilder(string Conn)
        {
        ...
        public EvolutionOfTotalNoOfClientsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionOfTotalNoOfClientsViewModel();
