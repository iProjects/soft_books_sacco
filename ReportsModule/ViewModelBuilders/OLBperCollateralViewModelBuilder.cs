...
{
    public class OLBperCollateralViewModelBuilder
    {
        ...
        public OLBperCollateralViewModelBuilder(string Conn)
        {
        ...
        public OLBperCollateralViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new OLBperCollateralViewModel();
