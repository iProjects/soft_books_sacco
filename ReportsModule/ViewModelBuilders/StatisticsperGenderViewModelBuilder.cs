...
{
    public class StatisticsperGenderViewModelBuilder
    {
        ...
        public StatisticsperGenderViewModelBuilder(string Conn)
        {
        ...
        public StatisticsPerGenderViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new StatisticsPerGenderViewModel();
