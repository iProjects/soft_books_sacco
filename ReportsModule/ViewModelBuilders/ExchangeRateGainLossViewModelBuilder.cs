...
{
    public class ExchangeRateGainLossViewModelBuilder
    {
        ...
        public ExchangeRateGainLossViewModelBuilder(string Conn)
        {
        ...
        public ExchangeRateGainorLossViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ExchangeRateGainorLossViewModel();
