...
{
    public class GuarantorsModelBuilder
    {
        ...
        public GuarantorsModelBuilder(string Conn)
        {
        ...
        public GuarantorsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new GuarantorsViewModel();
