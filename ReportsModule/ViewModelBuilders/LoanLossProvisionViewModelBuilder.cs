...
{
    public class LoanLossProvisionViewModelBuilder
    {
        ...
        public LoanLossProvisionViewModelBuilder(string Conn)
        {
        ...
        public LoanLossProvisionViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoanLossProvisionViewModel();
