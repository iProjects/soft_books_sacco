...
{
    public class DropoutReportViewModelBuilder
    {
        ...
        public DropoutReportViewModelBuilder(string Conn)
        {
        ...
        public DropoutReportViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DropoutReportViewModel();
