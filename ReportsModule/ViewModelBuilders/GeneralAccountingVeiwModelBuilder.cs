...
{
    public class GeneralAccountingViewModelBuilder
    {
        ...
        public GeneralAccountingViewModelBuilder(string Conn)
        {
        ...
        public GeneralAccountingViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new GeneralAccountingViewModel();
