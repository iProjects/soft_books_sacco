...
{
    public class CollateralReportsViewModelBuilder
    {
        ...
        public CollateralReportsViewModelBuilder(string Conn)
        {
        ...
        public CollateralReportsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new CollateralReportsViewModel();
