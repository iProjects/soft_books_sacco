...
{
    public class ActiveSavingsViewModelBuilder
    {
        ...
        public ActiveSavingsViewModelBuilder(string Conn)
        {
        ...
        public ActiveSavingsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ActiveSavingsViewModel();
