...
{
    public class LoansDisbursedViewModelBuilder
    {
        ...
        public LoansDisbursedViewModelBuilder(string Conn)
        {
        ...
        public LoansDisbursedViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoansDisbursedViewModel();
