...
{
    public class BadClientViewModelBuilder
    {
        ...
        public BadClientViewModelBuilder(string Conn)
        {
        ...
        public BadClientViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new BadClientViewModel();
