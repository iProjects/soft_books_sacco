...
{
    public class OLBperClientViewModelBuilder
    {
        ...
        public OLBperClientViewModelBuilder(string Conn)
        {
        ...
        public OLBperClientViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new OLBperClientViewModel();
