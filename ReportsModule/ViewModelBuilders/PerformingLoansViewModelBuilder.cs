...
{
    public class PerformingLoansViewModelBuilder
    {
        ...
        public PerformingLoansViewModelBuilder(string Conn)
        {
        ...
        public PerformingLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new PerformingLoansViewModel();
