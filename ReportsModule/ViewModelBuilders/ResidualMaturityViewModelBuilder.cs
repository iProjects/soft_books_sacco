...
{
    public class ResidualMaturityViewModelBuilder
    {
        ...
        public ResidualMaturityViewModelBuilder(string Conn)
        {
        ...
        public ResidualMaturityViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ResidualMaturityViewModel();
