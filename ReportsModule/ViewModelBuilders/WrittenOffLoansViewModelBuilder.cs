...
{
    public class WrittenOffLoansViewModelBuilder
    {
        ...
        public WrittenOffLoansViewModelBuilder(string Conn)
        {
        ...
        public WrittenoffLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new WrittenoffLoansViewModel();
