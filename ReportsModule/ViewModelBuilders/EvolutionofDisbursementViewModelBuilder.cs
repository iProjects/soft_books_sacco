...
{
    public class EvolutionofDisbursementViewModelBuilder
    {
        ...
        public EvolutionofDisbursementViewModelBuilder(string Conn)
        {
        ...
        public EvolutionofDisbursementModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionofDisbursementModel();
