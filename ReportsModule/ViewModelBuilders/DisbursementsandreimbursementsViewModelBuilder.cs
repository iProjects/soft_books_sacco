...
{
    public class DisbursementsandreimbursementsViewModelBuilder
    {
        ...
        public DisbursementsandreimbursementsViewModelBuilder(string Conn)
        {
        ...
        public DisbursementsandreimbursementsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DisbursementsandreimbursementsViewModel();
