...
{
    public class LoanOfficerOLBandPaRViewModelBuilder
    {
        ...
        public LoanOfficerOLBandPaRViewModelBuilder(string Conn)
        {
        ...
        public LoanOfficersOLBandPaRViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoanOfficersOLBandPaRViewModel();
