...
{
    public class DormantCustomersModelBuilder
    {
        ...
        public DormantCustomersModelBuilder(string Conn)
        {
        ...
        public DormantCustomersViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DormantCustomersViewModel();
