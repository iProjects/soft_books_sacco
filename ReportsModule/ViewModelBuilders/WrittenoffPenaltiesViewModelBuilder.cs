...
{
    public class WrittenoffPenaltiesViewModelBuilder
    {
        ...
        public WrittenoffPenaltiesViewModelBuilder(string Conn)
        {
        ...
        public WrittenoffPenaltiesViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new WrittenoffPenaltiesViewModel();
