...
{
    public class ClientandShareofWomenViewModelBuilder
    {
        ...
        public ClientandShareofWomenViewModelBuilder(string Conn)
        {
        ...
        public ClientsandShareofWomenViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClientsandShareofWomenViewModel();
