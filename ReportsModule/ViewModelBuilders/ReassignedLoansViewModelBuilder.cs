...
{
    public class ReassignedLoansViewModelBuilder
    {
        ...
        public ReassignedLoansViewModelBuilder(string Conn)
        {
        ...
        public ReassignedLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ReassignedLoansViewModel();
