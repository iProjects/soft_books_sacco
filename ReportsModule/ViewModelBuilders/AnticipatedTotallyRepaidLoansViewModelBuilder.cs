...
{
    class AnticipatedTotallyRepaidLoansViewModelBuilder
    {
        ...
        public AnticipatedTotallyRepaidLoansViewModelBuilder(string Conn)
        {
        ...
        public AnticipatedTotallyRepaidLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new AnticipatedTotallyRepaidLoansViewModel();
