...
{
    public class CreditLifeInsuranceViewModelBuilder
    {
        ...
        public CreditLifeInsuranceViewModelBuilder(string Conn)
        {
        ...
        public CreditLifeInsuranceViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new CreditLifeInsuranceViewModel();
