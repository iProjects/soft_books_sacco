...
{
    public class EvolutionOfTotalNoOfContractsViewModelBuilder
    {
        ...
        public EvolutionOfTotalNoOfContractsViewModelBuilder(string Conn)
        {
        ...
        public EvolutionOfTotalNoOfContractsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionOfTotalNoOfContractsViewModel();
