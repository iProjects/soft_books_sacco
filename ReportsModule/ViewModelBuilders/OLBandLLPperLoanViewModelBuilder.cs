...
{
    public class OLBandLLPperLoanViewModelBuilder
    {
        ...
        public OLBandLLPperLoanViewModelBuilder(string Conn)
        {
        ...
        public OLBandLLPperLoanViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new OLBandLLPperLoanViewModel();
