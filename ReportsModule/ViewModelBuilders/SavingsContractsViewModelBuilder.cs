...
{
    public class SavingsContractsViewModelBuilder
    {
        ...
        public SavingsContractsViewModelBuilder(string Conn)
        {
        ...
        public SavingsContractsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new SavingsContractsViewModel();
