...
{
    public class EvolutionOfRepaymentsModelBuilder
    {
        ...
        public EvolutionOfRepaymentsModelBuilder(string Conn)
        {
        ...
        public EvolutionOfRepaymentsModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionOfRepaymentsModel();
