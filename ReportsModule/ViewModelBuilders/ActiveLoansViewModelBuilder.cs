...
{
    public class ActiveLoansViewModelBuilder
    {
        ...
        public ActiveLoansViewModelBuilder(string Conn)
        {
        ...
        public ActiveLoansViewModels GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ActiveLoansViewModels();
