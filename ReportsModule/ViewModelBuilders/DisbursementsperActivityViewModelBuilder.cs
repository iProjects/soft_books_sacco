...
{
    public class DisbursementsperActivityViewModelBuilder
    {
        ...
        public DisbursementsperActivityViewModelBuilder(string Conn)
        {
        ...
        public DisbursementsperActivityViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DisbursementsperActivityViewModel();
