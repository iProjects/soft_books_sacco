...
{
    public class ResheduledLoansViewModelBuilder
    {
        ...
        public ResheduledLoansViewModelBuilder(string Conn)
        {
        ...
        public ResheduledLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ResheduledLoansViewModel();
