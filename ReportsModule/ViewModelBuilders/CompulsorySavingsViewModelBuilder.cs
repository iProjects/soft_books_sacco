...
{
    public class CompulsorySavingsViewModelBuilder
    {
        ...
        public CompulsorySavingsViewModelBuilder(string Conn)
        {
        ...
        public CompulsorySavingsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new CompulsorySavingsViewModel();
