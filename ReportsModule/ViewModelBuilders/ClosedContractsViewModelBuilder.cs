...
{
    public class ClosedContractsViewModelBuilder
    {
        ...
        public ClosedContractsViewModelBuilder(string Conn)
        {
        ...
        public ClosedContractsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClosedContractsViewModel();
