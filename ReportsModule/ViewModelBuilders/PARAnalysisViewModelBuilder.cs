...
{
    public class PARAnalysisViewModelBuilder
    {
        ...
        public PARAnalysisViewModelBuilder(string Conn)
        {
        ...
        public PARAnalysisViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new PARAnalysisViewModel();
