...
{
    public class EvolutionOfOLBModelBuilder
    {
        ...
        public EvolutionOfOLBModelBuilder(string Conn)
        {
        ...
        public EvolutionOfOLBModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionOfOLBModel();
