...
{
    public class DisbursementofTranchesViewModelBuilder
    {
        ...
        public DisbursementofTranchesViewModelBuilder(string Conn)
        {
        ...
        public DisbursementofTranchesViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DisbursementofTranchesViewModel();
