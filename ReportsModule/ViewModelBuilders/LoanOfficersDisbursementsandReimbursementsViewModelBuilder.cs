...
{
    public class LoanOfficersDisbursementsandReimbursementsViewModelBuilder
    {
        ...
        public LoanOfficersDisbursementsandReimbursementsViewModelBuilder(string Conn)
        {
        ...
        public LoanOfficerDisbursementsandReimbursementsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoanOfficerDisbursementsandReimbursementsViewModel();
