...
{
    public class LoanRenewalHelperViewModelBuilder
    {
        ...
        public LoanRenewalHelperViewModelBuilder(string Conn)
        {
        ...
        public LoanRenewalHelperViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoanRenewalHelperViewModel();
