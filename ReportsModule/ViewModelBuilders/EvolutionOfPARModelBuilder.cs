...
{
    public class EvolutionOfPARModelBuilder
    {
        ...
        public EvolutionOfPARModelBuilder(string Conn)
        {
        ...
        public EvolutionOfPARModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new EvolutionOfPARModel();
