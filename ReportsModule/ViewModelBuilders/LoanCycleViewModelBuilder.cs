...
{
    public class LoanCycleViewModelBuilder
    {
        ...
        public LoanCycleViewModelBuilder(string Conn)
        {
        ...
        public LoanCycleViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new LoanCycleViewModel();
