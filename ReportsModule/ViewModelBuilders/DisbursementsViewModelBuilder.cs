...
{
    public class DisbursementsViewModelBuilder
    {
        ...
        public DisbursementsViewModelBuilder(string Conn)
        {
        ...
        public DisbursementsViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new DisbursementsViewModel();
