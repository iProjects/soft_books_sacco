...
{
    public class NotDisbursedLoansViewModelBuilder
    {
        ...
        public NotDisbursedLoansViewModelBuilder(string Conn)
        {
        ...
        public NotDisbursedLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new NotDisbursedLoansViewModel();
