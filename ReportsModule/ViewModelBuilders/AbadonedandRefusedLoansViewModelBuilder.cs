...
{
    public class AbadonedandRefusedLoansViewModelBuilder
    {
        ...
        public AbadonedandRefusedLoansViewModelBuilder(string Conn)
        {
        ...
        public AbadonedandRefusedLoansViewModel GetModelBuilder()
        {
            try
            { 
                    Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new AbadonedandRefusedLoansViewModel();
