...
{
    public partial class AddBankBranchesForm : Form
    {
        ...
        #region "Constructor"
        public AddBankBranchesForm(string Conn)
        {
            InitializeComponent();
        ...
        //    try
        //    {
        //        var cn = (from c in db.gl_BankBranch
        //                  where c.gl_Banks.BankCode == _bank.BankCode
        ...
        private void btnAdd_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (is_Validate())
            {
                try
                {
                    ...
                    //gl_BankBranch _BankBranch = new gl_BankBranch();                      
                    ...
                    //{
                    //    _BankBranch.Bank = txtBankCode.Text.Trim();
                    //}
                    ...
                    //if (!db.gl_BankBranch.Any(c => c.Bank == _BankBranch.Bank && c.BranchCode == _BankBranch.BranchCode))
                    //{
                    //    db.gl_BankBranch.AddObject(_BankBranch);
                    //    db.SaveChanges();
                    //}
