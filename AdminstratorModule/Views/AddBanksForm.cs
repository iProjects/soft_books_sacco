...
namespace AdminstratorModule.Views
{
    public partial class AddBanksForm : Form
    {
        ...
        #region "Constructor"
        public AddBanksForm(string Conn)
        {
            InitializeComponent();
        ...
        private void btnAdd_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (is_validate())
            {
                try
                {
                    ...
                    //if (!db.gl_Banks.Any(c => c.BankCode == _Bank.BankCode))
                    //{
                    //    db.gl_Banks.AddObject(_Bank);
                    //    db.SaveChanges();
                    //}
